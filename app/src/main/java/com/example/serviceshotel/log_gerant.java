...
public class log_gerant extends AppCompatActivity {
    Button btn_inscrit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_gerant);
        ...
        sessionHandler3 = new SessionHandler3(this);
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(log_gerant.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                url = new URL("http://192.168.43.175:8080/test/login_gerant.php");
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Gerant gérant = new Gerant(Pseudo,Mot_de_passe) ;
                sessionHandler3.LoginGerant(gérant);

                Intent intent = new Intent(log_gerant.this,profGerant.class);
                startActivity(intent);
                log_gerant.this.finish();

            }else if (result.equalsIgnoreCase("false")){
                Toast.makeText(log_gerant.this, "Invalid email or password", Toast.LENGTH_LONG).show();

            } else if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {

                Toast.makeText(log_gerant.this, "OOPs! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
