...
public class ajout_responsable extends AppCompatActivity {
    String URLServeur ="http://51.255.106.21/test/ajout_responsable.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajout_responsable);
     ...
     btn_ajout.setOnClickListener((view) ->{
        if (ed_nom.getText().equals("")) {
            Toast.makeText(ajout_responsable.this, "Entrer les données s'il vous plait", Toast.LENGTH_SHORT).show();
        } else
    ...
    class Webservice extends AsyncTask<String, Void,String> {
        ...
        protected void onPreExecute() {
            pDialog = new ProgressDialog(ajout_responsable.this);
