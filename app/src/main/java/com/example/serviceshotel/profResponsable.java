...
public class profResponsable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prof_responsable);
      //  Objects.requireNonNull(getSupportActionBar()).setTitle("profil_responsable");
    ...
    private void getDetails() {
        if (sessionHandler.isLoggedIn()) {
            Responsable responsable = sessionHandler.getDetails();
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("pseudo", responsable.getPseudo()));
                nameValuePairs.add(new BasicNameValuePair("password", responsable.getPassword()));
