...
public class modif_chef extends AppCompatActivity {
    String URLServeur ="http://51.255.106.21/modif_chef.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modif_chef);
        ...
        btn_modif.setOnClickListener((view) -> {
            if (ed_id.getText().toString().equals("") || ed_nom.getText().toString().equals("") || ed_prénom.getText().toString().equals("") || ed_nat.getText().toString().equals("") || ed_cin.getText().toString().equals("")
                ...
                Toast.makeText(modif_chef.this, "Entrer les données s'il vous plait", Toast.LENGTH_SHORT).show();
            } else
    ...
    class Webservice extends AsyncTask<String, Void,String> {
        ...
        protected void onPreExecute() {
            pDialog = new ProgressDialog(modif_chef.this);
