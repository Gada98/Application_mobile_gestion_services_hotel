...
/*inscription de receptionniste*/
public class inscrit_receptionniste extends AppCompatActivity {
    TextView lang;
    Button reg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inscrit_receptionniste);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                backgroundTask2 back = new backgroundTask2(getApplicationContext());
                back.execute(nom, prénom, nationalité, N_CIN, adresse, numéro_téléphone, email, Pseudo, Mot_de_passe);
                if(!validate()){
                    Toast.makeText(inscrit_receptionniste.this, "l'inscription a echoué",Toast.LENGTH_SHORT).show();
                }
                else {
                    onSingupSuccess();
                    ...
                    Intent intent = new Intent(inscrit_receptionniste.this, log_receptionniste.class);
    ...
    private void showChangeLanguageDialog() {
        ...
        final AlertDialog.Builder mbuilder = new AlertDialog.Builder(inscrit_receptionniste.this);
