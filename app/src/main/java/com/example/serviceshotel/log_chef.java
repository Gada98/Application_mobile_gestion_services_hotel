...
public class log_chef extends AppCompatActivity {
    Button btn_inscrit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_chef);
        ...
        btn_inscrit.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), inscrit_chef.class);
            startActivity(intent);
        });
        sessionHandler2 = new SessionHandler2(this);
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(log_chef.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                url = new URL("http://192.168.43.175:8080/test/log_chef.php");
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Chef chef_cuisinier = new Chef(Pseudo,Mot_de_passe) ;
                sessionHandler2.LoginChef(chef_cuisinier);

                Intent intent = new Intent(log_chef.this,profChef.class);
                startActivity(intent);
                log_chef.this.finish();

            }else if (result.equalsIgnoreCase("false")){
                Toast.makeText(log_chef.this, "Invalid email or password", Toast.LENGTH_LONG).show();

            } else if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {

                Toast.makeText(log_chef.this, "OOPs! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
