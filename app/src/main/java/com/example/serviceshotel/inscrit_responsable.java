...
public class inscrit_responsable extends AppCompatActivity {
    TextView lang;
    Button reg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inscrit_responsable);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
                                   ...
                                   public void onClick(View view) {
                                       ...
                                       if(!validate()){
                                           Toast.makeText(inscrit_responsable.this, "l'inscription a echoué",Toast.LENGTH_SHORT).show();
                                       }
                                       else {
                                           onSingupSuccess();
                                           ...
                                           Intent intent = new Intent(inscrit_responsable.this, log_responsable.class);
    ...
    private void showChangeLanguageDialog() {
        ...
        final AlertDialog.Builder mbuilder = new AlertDialog.Builder(inscrit_responsable.this);
