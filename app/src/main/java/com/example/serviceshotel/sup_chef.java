...
public class sup_chef extends AppCompatActivity {
    String UrlServer="http://51.255.106.21/supp_chef.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sup_chef);
        Objects.requireNonNull(getSupportActionBar()).setTitle("supprimer_chef");
        ...
        btn_sup.setOnClickListener((view) -> {
            if(ed_id.getText().toString().equals("")){
                Toast.makeText(sup_chef.this,"Entre un ID s'il vous plait",Toast.LENGTH_SHORT).show();
            }
            else
    ...
    class Webservice extends AsyncTask<String, Void,String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(sup_chef.this);
