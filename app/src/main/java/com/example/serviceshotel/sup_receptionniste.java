...
public class sup_receptionniste extends AppCompatActivity {
    String UrlServer="http://51.255.106.21/supp_receptionniste.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sup_receptionniste);
        Objects.requireNonNull(getSupportActionBar()).setTitle("supprimer_receptionniste");
        ...
        btn_sup.setOnClickListener((view) -> {
            if(ed_id.getText().toString().equals("")){
                Toast.makeText(sup_receptionniste.this,"Entre un ID s'il vous plait",Toast.LENGTH_SHORT).show();
            }
            else
    ...
    class Webservice extends AsyncTask<String, Void,String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(sup_receptionniste.this);
