...
/*pour inscrit_receptionniste*/
public class backgroundTask2 extends AsyncTask<String, String, String> {
    private final String receptionnisteURL= "http://192.168.43.175:8080/test/inscrit_receptionniste.php";
    Context context;
    ...
    protected String doInBackground(String...strings) {
        ...
        try {
            URL url = new URL(receptionnisteURL);
            try {
