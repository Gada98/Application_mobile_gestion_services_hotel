...
public class inscription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!validate()){
                    Toast.makeText(inscription.this, "l'inscription a echoué",Toast.LENGTH_SHORT).show();
                }
                else {
                    onSingupSuccess();
                    ...
                    Intent intent = new Intent(inscription.this, log_gerant.class);
    ...
    private void showChangeLanguageDialog() {
        ...
        final AlertDialog.Builder mbuilder = new AlertDialog.Builder(inscription.this);
